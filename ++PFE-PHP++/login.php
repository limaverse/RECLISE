...
$error = '';
$lang = $_GET['lang'] ?? ($_SESSION['app_lang'] ?? 'fr');
...
?>
<!DOCTYPE html>
<html lang="<?php echo $lang; ?>" data-bs-theme="dark" dir="<?php echo $lang === 'ar' ? 'rtl' : 'ltr'; ?>">
<head>
<meta charset="UTF-8">
...
<div class="login-box">
<img src="assets/img/logo-light.svg" alt="Logo" class="logo-image" id="loginLogoLight"/>
<img src="assets/img/logo-dark.svg" alt="Logo" class="logo-image" id="loginLogoDark"/>
...
function updateLogos() {
    ...
    document.getElementById('loginLogoLight').style.display = isDark ? 'none' : 'block';
    document.getElementById('loginLogoDark').style.display = isDark ? 'block' : 'none';
}
